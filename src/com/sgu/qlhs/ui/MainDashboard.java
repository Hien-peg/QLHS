...
public class MainDashboard extends JFrame {
    ...
    private void buildUI() {
        ...
        sidebar.add(btnDash);  sidebar.add(Box.createVerticalStrut(6));
        sidebar.add(btnHs);    sidebar.add(Box.createVerticalStrut(6));
        sidebar.add(btnGv);    sidebar.add(Box.createVerticalStrut(6));
        sidebar.add(btnLp);    sidebar.add(Box.createVerticalStrut(6));
        sidebar.add(btntkb);    sidebar.add(Box.createVerticalStrut(6));
        sidebar.add(btnDiem);  sidebar.add(Box.createVerticalStrut(6));
        sidebar.add(btnTk);
    ...
    private void showCard(String key, SidebarButton[] all, SidebarButton active) {
        for (SidebarButton b : all) b.setActive(false);
