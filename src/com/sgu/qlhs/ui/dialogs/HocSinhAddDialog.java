...
public class HocSinhAddDialog extends JDialog {
    ...
    private void buildForm() {
        ...
        pnlHS.add(new JLabel("Mã HS:")); pnlHS.add(txtMa);
        ...
        btnSave.addActionListener(e -> {
            // TODO: xử lý lưu vào DB hoặc TableModel
            JOptionPane.showMessageDialog(this, "Đã lưu học sinh và thông tin phụ huynh!");
            dispose();
        });
