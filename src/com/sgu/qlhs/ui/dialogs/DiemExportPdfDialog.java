...
public class DiemExportPdfDialog extends JDialog {
    ...
    private void build(){
        ...
        form.add(new JLabel("Lớp:"));   form.add(cboLop);
        form.add(new JLabel("Môn:"));   form.add(cboMon);
        form.add(new JLabel("Học kỳ:"));form.add(cboHK);
        ...
        btnPane.add(btnClose); btnPane.add(btnExport);
