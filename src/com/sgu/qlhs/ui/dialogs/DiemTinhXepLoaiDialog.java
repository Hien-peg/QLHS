...
public class DiemTinhXepLoaiDialog extends JDialog {
    ...
    private final DefaultTableModel model = new DefaultTableModel(
            new Object[]{"Mã HS","Họ tên","Miệng","15p","Giữa kỳ","Cuối kỳ","TB","Xếp loại"}, 0) {
        @Override public boolean isCellEditable(int r,int c){ return c>=2 && c<=5; } // cho sửa điểm nguồn
        @Override public Class<?> getColumnClass(int c){ return (c>=2 && c<=6)? Double.class:String.class; }
    };

    public DiemTinhXepLoaiDialog(Window owner){
        super(owner, "Tính điểm TB + Xếp loại", ModalityType.APPLICATION_MODAL);
    ...
    private void build(){
        ...
        // demo
        model.addRow(new Object[]{1,"Nguyễn Văn A",8.5,7.0,8.0,8.5,null,null});
        model.addRow(new Object[]{2,"Trần Thị B",7.5,8.0,8.0,8.5,null,null});
        ...
        btnSave.addActionListener(e -> { /* TODO: ghi kết quả */ dispose(); });
